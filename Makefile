...
buddies: buddies.o easygame.o PerlinNoise.o
	clang++ -O3 -o buddies buddies.o easygame.o PerlinNoise.o -L/usr/local/lib -lSDL2 -lSDL2_image -lSDL2_mixer -framework OpenGL -lfann
